class Footprint {
    ...
    #createEntities() {
        ...
        this.#platformEntity = this.#viewer.entities.add({
            position: new Cesium.CallbackProperty(() => this.#snapshotSensorPos ? this.#snapshotSensorPos.clone() : undefined, false),
        ...
        this.#offsetEntity = this.#viewer.entities.add({
            polygon: {
                ...
                //     // const [r, g, b] = this.#offsetPolygonColor.map(c => c / 255);
